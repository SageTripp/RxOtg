...
Java_com_okq_rxdevice_serialPort_SerialPort_open(JNIEnv *env, jclass type, jstring path_, jint baudrate,
                                            jint flags) {
    int fd;
    speed_t speed;
...
Java_com_okq_rxdevice_serialPort_SerialPort_close(JNIEnv *env, jobject instance) {
